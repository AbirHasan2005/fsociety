...
fsocietylogo = color_random[0] + '''
        ...
        '''
fsocietyPrompt = "Choose an option: "
...
class fsociety:
    def __init__(self):
       ...
       }---------------{+} First Coded By Manisso {+}-------------{
       }-------------{+} Modified by @AbirHasan2005 {+}-----------{
       }---------{+} GitHub.com/AbirHasan2005/fsociety {+}--------{
    ''' + color.END + '''
       [0]--INSTALL & UPDATE
    ...
    def githubContributors(self):
        clearScr()
        print("\n\n\033[1;95m My Social Links:\n                  \033[1;92m GitHub:\033[1;96m https://github.com/AbirHasan2005\n                  \033[1;92m Twitter:\033[1;96m https://twitter.com/AbirHasan2005\n                  \033[1;92m Facebook:\033[1;96m https://facebook.com/AbirHasan2005\n                  \033[1;92m Instagram:\033[1;96m https://instagram.com/AbirHasan2005\n")
    ...
    def completed(self):
        raw_input("Completed, click ENTER to go back")
        self.__init__()

    def update(self):
        os.system("git clone --depth=1 https://github.com/AbirHasan2005/fsociety.git")
...
class passwordAttacksMenu:
    ...
    def __init__(self):
        ...
        print("   [99]-Back To Main Menu \n")
        choice3 = raw_input("Enter Command: ")
        clearScr()
        if choice3 == "1":
            cupp()
        elif choice3 == "2":
...
if __name__ == "__main__":
    try:
        ...
        print("\n\n\033[1;92mJoin Telegram Group:\033[1;96m http://t.me/linux_repo")
        time.sleep(1)
        print("\n\033[1;91mExiting ...\n")
        time.sleep(1.25)
